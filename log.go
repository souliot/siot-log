...
// EnableFullFilePath set log FullFilePath
func (bl *BeeLogger) EnableFullFilePath(b bool) {
	bl.enableFullFilePath = b
}
...
func (bl *BeeLogger) SetPrefix(s string) {
	if s != "" {
		s = fmt.Sprintf(`[%s] `, strings.Title(s))
	}
	bl.prefix = s
}

// get prefix
func (bl *BeeLogger) GetPrefix() string {
	return bl.prefix
}

// set prefix
func (bl *BeeLogger) WithPrefix(s string) {
	if s != "" {
		s = fmt.Sprintf(`[%s] `, strings.Title(s))
	}
	bl.prefix += s
